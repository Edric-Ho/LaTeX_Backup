...
Major: Applied Math \& Computer Science (Intended)  \hfill Sep. 2023 - Present\\ % Degree and GPA
Relevant Coursework: Mathematical Analysis, Abstract Algebra, Software Design, Statistical Reasoning and Data Science, Data Structures, Theory of Computation, Computer Organization, Systems Programming. % Additional info
...
\section*{SKILLS}
\begin{itemize}
    \item \textbf{Programming Languages:} Python, Java, HTML5, CSS3, JavaScript, SASS % Programming skills
    \item \textbf{Library/Frameworks:} SciPy, NumPy, Plotly, Matplotlib, Sklearn, JSON
    \item \textbf{Software:} Pycharm, VSCode, IntelliJ, Webstorm, DataSpell, Git, Obsidian. % Software skills
